...
export type RowCompany = {pk: number; name: string};
...
export type SegmentOriginStatus = "on_loading_site" | "loading_complete" | "none";
export type SegmentDestinationStatus = "on_unloading_site" | "unloading_complete" | "none";
...
// Type returned by /api/v4/scheduler/
export type RawCarrierCharteringSchedulerSegment = {
    uid: string;
    created: string;
...
export type CharteringView = "chartering";
