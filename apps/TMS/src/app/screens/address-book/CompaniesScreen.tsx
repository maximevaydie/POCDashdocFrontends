...
import {RESET_PARTNER_SETTINGS} from "app/features/address-book/companies/constants";
import {PartnerList} from "app/features/address-book/companies/PartnerList";
import {PartnersAction} from "app/features/address-book/companies/PartnersAction";
import {PartnersFilteringBar} from "app/features/address-book/companies/PartnersFilteringBar";
import {
    PARTNER_VIEW_CATEGORY,
    PartnersScreenQuery,
    PartnersSettingsSchema,
} from "app/features/address-book/companies/types";
import {getCompaniesForCurrentQuery} from "app/redux/selectors/searches";
...
export function CompaniesScreen() {
    ...
    const {totalCount} = useSelector(getCompaniesForCurrentQuery);
