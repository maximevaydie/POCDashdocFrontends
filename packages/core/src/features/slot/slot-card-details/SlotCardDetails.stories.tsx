...
import {Props, SlotCardDetails} from "./SlotCardDetails";

export default {
    title: "flow/features/zones/SlotCardDetails",
    component: SlotCardDetails,
} as Meta;

const Template: Story<Props> = (args) => (
    <Box width="316px">
        <SlotCardDetails {...args} timezone="Europe/Paris" />
    </Box>
);
